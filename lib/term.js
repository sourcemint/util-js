...
// -- cadorn Christoph Dorn Copyright (C) 2012 MIT License
...
exports.setIndent = function(num, character) {
    var padding = "";
    for (var i=0;i<num;i++) padding += character;
    indent = [num, character, padding];
}
...
exports.Stream = function (system) {
    ...
    var bold = "0";
    var stack = [];
    var enabled = UTIL.has(terms, process.env.TERM);
...
var termStream = new exports.Stream({
    stdout: makeWriter(process.stdout),
    stderr: makeWriter(process.stderr)
});
